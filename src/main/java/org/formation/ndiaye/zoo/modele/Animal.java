 ...
 *
 * @author J.Vincensini
 * @see org.formation.ndiaye.zoo.modele.Lion
 * @version 1.0
 *
 */
public abstract class Animal implements EtreVivant {
	...
	@Deprecated
	public String manger(EtreVivant i) {
		return "BEURK";
	...
	public String manger(Mangeable m) throws BeurkException {
		String tmp ="";
		tmp = String.join(" ","je suis un(e)",this.getClass().getSimpleName(),"et je ne mange pas de",m.getClass().getSimpleName());
		throw new BeurkException(tmp);
	}
	...
	protected void finalize() throws Throwable {
		String s = String.join("", "je suis un(e)", this.getClass().getSimpleName()," et je meurt");
